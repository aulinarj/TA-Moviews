...
public class TopRateFragment extends Fragment {
    ...
    private void downloadDataSources() {
        String url = "https://api.themoviedb.org/3/movie/top_rated?api_key=7a60bfebebe5a60abd25c632486bfcea";
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mAdapter = new TopRateAdapter(this.getActivity(), mList);
