...
public class ComingSoonFragment extends Fragment {
    ...
    private void downloadDataSources() {
        String url = "https://api.themoviedb.org/3/movie/upcoming?api_key=7a60bfebebe5a60abd25c632486bfcea";
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        RecyclerView recyclerView = (RecyclerView) getView().findViewById(R.id.recyclerViewComing);
